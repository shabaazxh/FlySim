#############################################################################
# Makefile for building: A1_handout.app/Contents/MacOS/A1_handout
# Generated by qmake (3.1) (Qt 6.5.2)
# Project:  A1_handout.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile A1_handout.pro
#############################################################################
...
CXXFLAGS      = -pipe -stdlib=libc++ -DGL_SILENCE_DEPRECATION -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=13.0 -Wall -Wextra $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = A1_handout1.0.0
DISTDIR = /Users/shabaazh/Desktop/A1_handout/.tmp/A1_handout1.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -framework QtOpenGLWidgets -framework QtOpenGL -framework QtWidgets -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtCore -framework IOKit -framework DiskArbitration -framework AGL -framework OpenGL   
...
OBJECTS       = Cartesian3.o \
		...
		SceneModel.o \
		Terrain.o \
		moc_FlightSimulatorWidget.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/macx.conf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/sanitize.conf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/gcc-base.conf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/gcc-base-mac.conf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/clang.conf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/clang-mac.conf \
		...
		SceneModel.cpp \
		Terrain.cpp
QMAKE_TARGET  = A1_handout
DESTDIR       = 
TARGET        = A1_handout.app/Contents/MacOS/A1_handout

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 13.3
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/shabaazh/Desktop/A1_handout/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/shabaazh/Desktop/A1_handout/A1_handout.pro


include /opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

A1_handout.app/Contents/MacOS/A1_handout:  $(OBJECTS)  
	@test -d A1_handout.app/Contents/MacOS/ || mkdir -p A1_handout.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: A1_handout.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.5.2/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile A1_handout.pro
...
A1_handout.app/Contents/PkgInfo: 
	@test -d A1_handout.app/Contents || mkdir -p A1_handout.app/Contents
	@$(DEL_FILE) A1_handout.app/Contents/PkgInfo
	@echo "APPL????" > A1_handout.app/Contents/PkgInfo
A1_handout.app/Contents/Info.plist: 
	@test -d A1_handout.app/Contents || mkdir -p A1_handout.app/Contents
	@$(DEL_FILE) A1_handout.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.A1-handout,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.A1-handout,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},13.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,A1_handout,g" -e "s,@LIBRARY@,A1_handout,g" -e "s,\$${EXECUTABLE_NAME},A1_handout,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >A1_handout.app/Contents/Info.plist

all: Makefile \
		A1_handout.app/Contents/PkgInfo \
		A1_handout.app/Contents/Info.plist A1_handout.app/Contents/MacOS/A1_handout
...
moc_predefs.h: /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
	/Library/Developer/CommandLineTools/usr/bin/clang++ -pipe -stdlib=libc++ -DGL_SILENCE_DEPRECATION -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=13.0 -Wall -Wextra -dM -E -o moc_predefs.h /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc_FlightSimulatorWidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_FlightSimulatorWidget.cpp
moc_FlightSimulatorWidget.cpp: FlightSimulatorWidget.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/shabaazh/Desktop/A1_handout/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/shabaazh/Desktop/A1_handout -I/Users/shabaazh/Desktop/A1_handout -I/opt/homebrew/lib/QtOpenGLWidgets.framework/Headers -I/opt/homebrew/lib/QtOpenGL.framework/Headers -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/14.0.3/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib FlightSimulatorWidget.h -o moc_FlightSimulatorWidget.cpp
...
FlightSimulatorWidget.o: FlightSimulatorWidget.cpp FlightSimulatorWidget.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QtGlobal \
		/opt/homebrew/lib/QtCore.framework/Headers/qglobal.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QTimer \
		/opt/homebrew/lib/QtCore.framework/Headers/qtimer.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QElapsedTimer \
		/opt/homebrew/lib/QtCore.framework/Headers/qelapsedtimer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o FlightSimulatorWidget.o FlightSimulatorWidget.cpp

Homogeneous4.o: Homogeneous4.cpp Homogeneous4.h \
		Cartesian3.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Homogeneous4.o Homogeneous4.cpp

HomogeneousFaceSurface.o: HomogeneousFaceSurface.cpp HomogeneousFaceSurface.h \
		Homogeneous4.h \
		Cartesian3.h \
		Matrix4.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o HomogeneousFaceSurface.o HomogeneousFaceSurface.cpp

main.o: main.cpp FlightSimulatorWidget.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QtGlobal \
		/opt/homebrew/lib/QtCore.framework/Headers/qglobal.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QTimer \
		/opt/homebrew/lib/QtCore.framework/Headers/qtimer.h \
...
SceneModel.o: SceneModel.cpp SceneModel.h \
		HomogeneousFaceSurface.h \
		Homogeneous4.h \
		Cartesian3.h \
		Matrix4.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QElapsedTimer \
		/opt/homebrew/lib/QtCore.framework/Headers/qelapsedtimer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SceneModel.o SceneModel.cpp
...
moc_FlightSimulatorWidget.o: moc_FlightSimulatorWidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_FlightSimulatorWidget.o moc_FlightSimulatorWidget.cpp
